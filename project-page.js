...
function submitNewProject() {
  ...
  setTimeout(() => {
    if (typeof openProjectPage === 'function') openProjectPage(project.id)
...
function loadProjectsSection() {
  ...
  sec.innerHTML = projects.map(p => `
    <div onclick="typeof openProjectPage==='function'?openProjectPage(${p.id}):openProjectPanel(${p.id})" style="display:flex;align-items:center;gap:8px;padding:9px 12px;margin:2px 8px;border-radius:10px;cursor:pointer;transition:background 0.15s;" 
      onmouseover="this.style.background='rgba(255,215,0,0.05)'" onmouseout="this.style.background='none'">
