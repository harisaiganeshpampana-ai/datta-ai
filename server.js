...
app.post("/chat", upload.single("image"), authMiddleware, async (req, res) => {
  try {
    ...
    const validModels = ["llama-3.1-8b-instant","llama-3.3-70b-versatile","llama3-70b-8192","llama-3.3-70b-versatile","llama-3.3-70b-versatile","meta-llama/llama-4-scout-17b-16e-instruct"]
