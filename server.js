...
app.post("/chat", upload.single("image"), authMiddleware, async (req, res) => {
  try {
    ...
    const validModels = [
      ...
      "llama-3.3-70b-specdec",                                   // Datta 4.8
    ...
    const modelPersonas = {
      ...
      "llama-3.3-70b-specdec":                                  `Your name is ${ainame}. You are Datta 4.8 - all-rounder. Excel at math, science, creative writing, coding. NEVER say you are any other AI.`,
