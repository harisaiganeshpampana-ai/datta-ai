...
function downloadAsPDF(btn) {
  ...
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 800px; margin: 40px auto; padding: 20px; color: #111; line-height: 1.8; }
    h1,h2,h3 { color: #111; }
    ...
    blockquote { border-left: 3px solid #00cc66; padding-left: 16px; color: #555; }
    .header { border-bottom: 2px solid #00cc66; padding-bottom: 12px; margin-bottom: 24px; }
    .footer { border-top: 1px solid #ddd; padding-top: 12px; margin-top: 24px; color: #999; font-size: 12px; }
    @media print { body { margin: 0; } }
  </style>
  </head><body>
  <div class="header">
    <div style="font-size:20px;font-weight:700;color:#00cc66;">Datta AI</div>
    <div style="color:#999;font-size:13px;">Exported on ${new Date().toLocaleString("en-IN")}</div>
  </div>
  <div>${html}</div>
  <div class="footer">Generated by Datta AI · datta-ai.com</div>
  </body></html>`)
  win.document.close()
